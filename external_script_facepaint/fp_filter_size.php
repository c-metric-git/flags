...
$myFile = "csv/fp_filter_size.csv"; // File in which attribute option values are there.  fp_filter_size &&  FP_Powder Makeup_Sizes.csv
$f = fopen($myFile, "r");
...
for($i=0;$i<count($myValue);$i++)
 ...
 $attribute_code  = $attribute_model->getIdByCode('catalog_product', 'fp_filter_size');
 $attribute       = $attribute_model->load($attribute_code);
 
if(!attributeValueExists('fp_filter_size', $myValue[$i]))
 {
