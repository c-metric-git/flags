...
$myFile = "csv/FP_Tattoos_Stencils_Stamp_Types.csv"; // File in which attribute option values are there.
$f = fopen($myFile, "r");
...
for($i=0;$i<count($myValue);$i++)
 ...
 $attribute_code  = $attribute_model->getIdByCode('catalog_product', 'fp_filter_types');
 $attribute       = $attribute_model->load($attribute_code);
 
if(!attributeValueExists('fp_filter_types', $myValue[$i]))
 {
