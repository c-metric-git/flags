...
$myFile = "csv/FP_Attributes_Colors.csv"; // File in which attribute option values are there.
$f = fopen($myFile, "r");
...
for($i=0;$i<count($myValue);$i++)
 ...
 $attribute_code  = $attribute_model->getIdByCode('catalog_product', 'fp_color');
 $attribute       = $attribute_model->load($attribute_code);
 
if(!attributeValueExists('fp_color', $myValue[$i]))
 {
