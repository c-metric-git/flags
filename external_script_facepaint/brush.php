...
$myFile = "csv/brush.csv"; // File in which attribute option values are there.
$f = fopen($myFile, "r");
...
for($i=0;$i<count($myValue);$i++)
 ...
 $attribute_code  = $attribute_model->getIdByCode('catalog_product', 'brush');
 $attribute       = $attribute_model->load($attribute_code);
 
if(!attributeValueExists('brush', $myValue[$i]))
 {
