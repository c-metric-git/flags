...
$myFile = "csv/fp_filter_colors.csv"; // File in which attribute option values are there.
$f = fopen($myFile, "r");
...
for($i=0;$i<count($myValue);$i++)
 ...
 $attribute_code  = $attribute_model->getIdByCode('catalog_product', 'fp_filter_colors');
 $attribute       = $attribute_model->load($attribute_code);
 
if(!attributeValueExists('fp_filter_colors', $myValue[$i]))
 {
