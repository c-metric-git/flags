...
$myFile = "csv/FP_Attributes_Size.csv"; // File in which attribute option values are there.
$f = fopen($myFile, "r");
...
for($i=0;$i<count($myValue);$i++)
 ...
 $attribute_code  = $attribute_model->getIdByCode('catalog_product', 'fp_size');
 $attribute       = $attribute_model->load($attribute_code);
 
if(!attributeValueExists('fp_size', $myValue[$i]))
 {
...
//exit;
 ...
 echo "successfully done! India good morning.<br>";
 }
 }
