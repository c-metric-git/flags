...
$myFile = "csv/brand_and_size.csv"; // File in which attribute option values are there.
$f = fopen($myFile, "r");
...
for($i=0;$i<count($myValue);$i++)
 ...
 $attribute_code  = $attribute_model->getIdByCode('catalog_product', 'brand_and_size');
 $attribute       = $attribute_model->load($attribute_code);
 
if(!attributeValueExists('brand_and_size', $myValue[$i]))
 {
