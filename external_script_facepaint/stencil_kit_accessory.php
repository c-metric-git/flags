...
$myFile = "csv/stencil_kit_accessory.csv"; // File in which attribute option values are there.
$f = fopen($myFile, "r");
...
for($i=0;$i<count($myValue);$i++)
 ...
 $attribute_code  = $attribute_model->getIdByCode('catalog_product', 'stencil_kit_accessory');
 $attribute       = $attribute_model->load($attribute_code);
 
if(!attributeValueExists('stencil_kit_accessory', $myValue[$i]))
 {
