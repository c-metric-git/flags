            ...
            if(allowedProducts.size()>0)
            {
                if (this.config.attributes[attributeId].use_image)
                {
                    ...
                    if (options[i].color) {
                        var width = 25;
                        var height = 25;
                        if (parseInt(this.config.attributes[attributeId].config.cat_small_width)) {
                            width = parseInt(this.config.attributes[attributeId].config.cat_small_width);
                        }
                        if (parseInt(this.config.attributes[attributeId].config.cat_small_height)) {
                            height = parseInt(this.config.attributes[attributeId].config.cat_small_height);
                        }
                        ...
                        if(this.config.attributes[attributeId].config && this.config.attributes[attributeId].config.cat_use_tooltip != "0" && 'undefined' != typeof(jQuery)){
                            ...
                            switch (this.config.attributes[attributeId].config.cat_use_tooltip) {
                                case "1":
                                    ...
                                    break;
                                case "2":
                                    amcontent = '<div class="amtooltip-img"><div style="width: ' + width + 'px; height:' + height + 'px; margin: 0 auto;  background: #' + options[i].color + '"></div></div>';
                                    break;
                                case "3":
                                    amcontent = '<div class="amtooltip-img"><div style="width: ' + width + 'px; height:' + height + 'px; margin: 0 auto; background: #' + options[i].color + '"></div><div class="amtooltip-label">' + options[i].label + '</div>';
                                    break;
                            }
                            try{
                        ...
                        if(this.config.attributes[attributeId].config && this.config.attributes[attributeId].config.cat_use_tooltip != "0" && 'undefined' != typeof(jQuery)){
                            ...
                            switch (this.config.attributes[attributeId].config.cat_use_tooltip) {
                                case "1":
                                    ...
                                    break;
                                case "2":
                                    amcontent = '<div class="amtooltip-img" style="width: ' + width + 'px; height:' + height + 'px; margin: 0 auto;"><img src="' + options[i].bigimage + '"/></div>';
                                    break;
                                case "3":
                                    amcontent = '<div class="amtooltip-img" style="width: ' + width + 'px; height:' + height + 'px; margin: 0 auto;"><img src="' + options[i].bigimage + '"/></div><div class="amtooltip-label">' + options[i].label + '</div>';
                                    break;
                            }
                            try{
