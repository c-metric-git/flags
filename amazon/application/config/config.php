...
$config['sitename']         = "Amazon API"; 

//For teamwork details
$config['td_email']         = 'kashyap.padh@tops-int.com';
$config['td_password']      = 'thirteen13';
$config['td_domain']        = 'clownantics.teamdesk.net';
$config['td_api_key']       =  27503;
