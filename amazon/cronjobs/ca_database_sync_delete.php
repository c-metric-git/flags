...
$dataset = $api->GetSchema("Amazon Entry",array('sku','isVisibleOnAmazonCAN?','recordHistory','amazonErrorReason','ASIN','isReadyForDeletionToCanAmz?'));
...
$result = $api->Query("SELECT [sku], [Product - SKU], [parentage], [isReadyForDeletionToCanAmz?] FROM [Amazon Entry] WHERE [isReadyForDeletionToCanAmz?]=TRUE ORDER BY [sku] DESC");
