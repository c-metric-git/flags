...
$submission_list = $mysqli->query('SELECT id, product_id, sku, feed_type, feed_id FROM error_reporting WHERE processed="0" AND feed_type = "Product Posting" AND `isAmazonCANProduct?` != "1" AND `isAmazonUKProduct?` != "1"');
        ...
        {     
            ...
            {     
...

                {
                    ...
                    $update_arr[$rows_submission_list['product_id']]['sku'] = $rows_submission_list['sku'];
...
{    
    ...
    {        
        ...
        echo "SKU: ",$updates['sku'],"<br/>Team desk details updated successfully for id: ",$product_id,"<br/>";
