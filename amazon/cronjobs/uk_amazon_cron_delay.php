...
{    
    ...
    $feed_arr[$key]['isAmazonUKProduct?'] = (isset($feeds['Product - isAmazonUKProduct?']) && $feeds['Product - isAmazonUKProduct?'] != '') ? $feeds['Product - isAmazonUKProduct?'] : ''; // for uk
    ...
    $feed_arr[$key]['recommendedBrowseNode']        = (isset($feeds['Amazon Category - recommendedBrowseNodeUK']) && intval($feeds['Amazon Category - recommendedBrowseNodeUK'])>0) ? $feeds['Amazon Category - recommendedBrowseNodeUK'] : '366064031'; // added by lav
...

    {
        ...
        {            
            ...
            $feed_arr[$key]['variations'][$count]['recommendedBrowseNode']         = (isset($var['Amazon Category - recommendedBrowseNodeUK']) && intval($var['Amazon Category - recommendedBrowseNodeUK'])>0) ? $var['Amazon Category - recommendedBrowseNodeUK'] : '366064031'; // added by lav
...

{
    ...
    */
    ...
    //echo $product_feed['recommendedBrowseNode']; exit;
    $feed .= "<RecommendedBrowseNode>".intval($product_feed['recommendedBrowseNode'])."</RecommendedBrowseNode>";
    ...
    $feed .= "</".$product_feed['product_type']."></ProductData>";*/
    
    $feed .= "</Product></Message>";
...

    {
...

        {
            ...
            */
            ...
            if($var_val['recommendedBrowseNode'] != '') {

                $feed .= "<RecommendedBrowseNode>".intval($var_val['recommendedBrowseNode'])."</RecommendedBrowseNode>";
    ...
    $tmpfname = $_SERVER['DOCUMENT_ROOT'] .'/'.FOLDER_NAME."/cronjobs/product_xml_files/UK_product_update_".date('Y').date('m').date('d')."_".date('H').date("i").".xml";  
    ...
    if($feedVar!=""){
        ...
        $tmpfname = $_SERVER['DOCUMENT_ROOT'] .'/'.FOLDER_NAME."/cronjobs/product_varaiation_xml_files/UK_product_update_".date('Y').date('m').date('d')."_".date('H').date("i").".xml";  
            ...
            foreach($feed_arr as $key => $product_feed){
                if(isset($product_feed['variations']) && count($product_feed['variations'])>0){
                    foreach($product_feed['variations'] as $key => $product_var_feed){
                        $mysqli->query('INSERT INTO error_reporting VALUES (null, "'.$product_var_feed['product_id'].'", "'.$product_var_feed['SKU'].'","Variation Posting","'.$response->SubmitFeedResult->FeedSubmissionInfo->FeedSubmissionId.'",null,"0",null,"","'.$product_var_feed['isAmazonUKProduct?'].'")');   
                    }
                }
            }
