...
mail("uzzal@clownantics.com","UK Amazon Product Posting Started",$meesage);  
...
include_once "uk_database_sync.php";
...
include_once "uk_amazon_cron_delay.php";
...
include_once "uk_amazon_error_reporting_delay.php";
...
include_once "uk_amazon_product_asin_update.php";
...
mail("uzzal@clownantics.com","UK Amazon Product Posting Completed",$message);
