...

{
...

    {
        ...
        //$mysqli->query('INSERT INTO error_reporting VALUES (null, "'.$product_feed['product_id'].'", "'.$product_feed['SKU'].'","Product Posting",null,"503 error on product feed call","0",null,"'.$product_feed['isAmazonCANProduct?'].'",null)');      
...

{
...

    {
        ...
        //$mysqli->query('INSERT INTO error_reporting VALUES (null,"'.$product_feed['product_id'].'", "'.$product_feed['SKU'].'","Image Posting",null,"503 error for image posting","0",null,"'.$product_feed['isAmazonCANProduct?'].'",null)');
...

{
...

    {
        ...
        //$mysqli->query('INSERT INTO error_reporting VALUES (null, "'.$product_feed['product_id'].'", "'.$product_feed['SKU'].'","Variation Posting",null,"503 error for variation posting","0",null,"'.$product_feed['isAmazonCANProduct?'].'",null)');      
...

{
...

    {
        ...
        //$mysqli->query('INSERT INTO error_reporting VALUES (null, "'.$product_feed['product_id'].'", "'.$product_feed['SKU'].'","Quantity Posting",null,"503 error for quantity posting","0",null,"'.$product_feed['isAmazonCANProduct?'].'",null)');
...

{
...

    {
        ...
        //$mysqli->query('INSERT INTO error_reporting VALUES (null,"'.$product_feed['product_id'].'", "'.$product_feed['SKU'].'","Price Posting",null,"503 error for price posting","0",null,"'.$product_feed['isAmazonCANProduct?'].'",null)');
