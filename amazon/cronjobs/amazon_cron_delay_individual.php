...
{   
    global $all_scripts,$base_path;
    if($all_scripts != 'Yes') {   
        $_SERVER['DOCUMENT_ROOT'] = "/home/julian2010/public_html";
...
$result = $api->Query("SELECT ".$TD_field_name." FROM [Amazon Entry] WHERE [isReadyForUpdate?] ORDER BY [sku] DESC");
