...
$dataset = $api->GetSchema("Amazon Entry",array('sku','isVisibleOnAmazon?','recordHistory','amazonErrorReason','ASIN','isReadyForDeletion?'));
...
$result = $api->Query("SELECT [sku], [Product - SKU], [parentage], [isReadyForDeletion?] FROM [Amazon Entry] WHERE [isReadyForDeletion?]=TRUE ORDER BY [sku] DESC");
