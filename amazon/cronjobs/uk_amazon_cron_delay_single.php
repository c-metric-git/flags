...
$sql = 'SELECT * FROM ready_for_amazon WHERE is_visible = "1" AND `isReadyForUpdateToUkAmz?` = "1"';
...
{    
    ...
    $feed_arr[$key]['UK Amz ASIN']             = (isset($feeds['UK Amz ASIN']) && $feeds['UK Amz ASIN'] != '') ? $feeds['UK Amz ASIN'] : '';
    
    $feed_arr[$key]['isAmazonUKProduct?'] = (isset($feeds['Product - isAmazonUKProduct?']) && $feeds['Product - isAmazonUKProduct?'] != '') ? $feeds['Product - isAmazonUKProduct?'] : '0'; // for canada
    ...
    $feed_arr[$key]['MSRP']             = (isset($feeds['Product - UK Price']) && $feeds['Product - UK Price'] != '') ? $feeds['Product - UK Price'] : '';

    $feed_arr[$key]['StandardPrice']    = (isset($feeds['Product - UK Price']) && $feeds['Product - UK Price'] != '') ? $feeds['Product - UK Price'] : '';
...

    {
        ...
        {            
            ...
            $feed_arr[$key]['variations'][$count]['MSRP']                          = (isset($var['Product - UK Price']) && $var['Product - UK Price'] != '') ? $var['Product - UK Price'] : '';

            $feed_arr[$key]['variations'][$count]['StandardPrice']                 = (isset($var['Product - UK Price']) && $var['Product - UK Price'] != '') ? $var['Product - UK Price'] : '';
            ...
            $feed_arr[$key]['variations'][$count]['isAmazonUKProduct?'] = (isset($var['Product - isAmazonUKProduct?']) && $var['Product - isAmazonUKProduct?'] != '') ? $var['Product - isAmazonUKProduct?'] : '0'; // for uk            
...

{
    ...
    if($product_feed['UK Amz ASIN'])

        $feed .= "<StandardProductID><Type>ASIN</Type><Value>".$product_feed['UK Amz ASIN']."</Value></StandardProductID>";
    ...
    if ($product_feed['MSRP'] != '')
        ...
        $feed .= "<MSRP currency='GBP'>" . $product_feed['MSRP'] . "</MSRP>";
...

    {
        ...
        {            
            ...
            if ($var_val['MSRP'] != '')
                ...
                $feed .= "<MSRP currency='GBP'>" . $var_val['MSRP'] . "</MSRP>";
...

{
    ...
    {            
        ...
        $mysqli->query('INSERT INTO error_reporting VALUES (null, "'.$product_feed['product_id'].'", "'.$product_feed['SKU'].'","Product Posting","'.$response->SubmitFeedResult->FeedSubmissionInfo->FeedSubmissionId.'",null,"0",null,"","'.$product_feed['isAmazonUKProduct?'].'")');
...

    {
        ...
        $mysqli->query('INSERT INTO error_reporting VALUES (null, "'.$product_feed['product_id'].'", "'.$product_feed['SKU'].'","Product Posting",null,"503 error on product feed call","0",null,"","'.$product_feed['isAmazonUKProduct?'].'")');      
...

{
...

        {
...

            {
...

                {
                    ...
                    $mysqli->query('INSERT INTO error_reporting VALUES (null,"'.$product_feed['product_id'].'", "'.$product_feed['SKU'].'","Image Posting","'.$response->SubmitFeedResult->FeedSubmissionInfo->FeedSubmissionId.'",null,"0",null,"","'.$product_feed['isAmazonUKProduct?'].'")');
...

    {
        ...
        $mysqli->query('INSERT INTO error_reporting VALUES (null,"'.$product_feed['product_id'].'", "'.$product_feed['SKU'].'","Image Posting",null,"503 error for image posting","0",null,"","'.$product_feed['isAmazonUKProduct?'].'")');
...

{
...

    {
        ...
        {                
            ...
            $mysqli->query('INSERT INTO error_reporting VALUES (null, "'.$product_feed['product_id'].'", "'.$product_feed['SKU'].'","Variation Posting","'.$response->SubmitFeedResult->FeedSubmissionInfo->FeedSubmissionId.'",null,"0",null,"","'.$product_feed['isAmazonUKProduct?'].'")');
...

    {
        ...
        $mysqli->query('INSERT INTO error_reporting VALUES (null, "'.$product_feed['product_id'].'", "'.$product_feed['SKU'].'","Variation Posting",null,"503 error for variation posting","0",null,"","'.$product_feed['isAmazonUKProduct?'].'")');      
...

{
...

    {
...

        {
            ...
            $mysqli->query('INSERT INTO error_reporting VALUES (null, "'.$product_feed['product_id'].'", "'.$product_feed['SKU'].'","Quantity Posting","'.$response->SubmitFeedResult->FeedSubmissionInfo->FeedSubmissionId.'",null,"0",null,"","'.$product_feed['isAmazonUKProduct?'].'")');
...

    {
        ...
        $mysqli->query('INSERT INTO error_reporting VALUES (null, "'.$product_feed['product_id'].'", "'.$product_feed['SKU'].'","Quantity Posting",null,"503 error for quantity posting","0",null,"","'.$product_feed['isAmazonUKProduct?'].'")');
...

            {
                ...
                $feed .= "<Message>
                        ...
                        <Price>
                            ...
                            <StandardPrice currency='GBP'>".$product_feed['StandardPrice']."</StandardPrice>
...

                {
                    ...
                    $feed .= "<Message>
                                ...
                                <Price>
                                    ...
                                    <StandardPrice currency='GBP'>".$var_val['MSRP']."</StandardPrice>
...

{
...

    {
...

        {
            ...
            $mysqli->query('INSERT INTO error_reporting VALUES (null,"'.$product_feed['product_id'].'", "'.$product_feed['SKU'].'","Price Posting","'.$response->SubmitFeedResult->FeedSubmissionInfo->FeedSubmissionId.'",null,"0",null,"","'.$product_feed['isAmazonUKProduct?'].'")');
...

    {
        ...
        $mysqli->query('INSERT INTO error_reporting VALUES (null,"'.$product_feed['product_id'].'", "'.$product_feed['SKU'].'","Price Posting",null,"503 error for price posting","0",null,"","'.$product_feed['isAmazonUKProduct?'].'")');
