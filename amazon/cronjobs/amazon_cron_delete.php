...
$sql = 'SELECT `@id`, `Product - SKU`, `sku`, `parentage` FROM ready_for_deletion WHERE `isReadyForDeletion?` = "1"';
...
{ 
...

    {
        ...
        $mysqli->query('INSERT INTO error_reporting VALUES (null, "'.$product_feed['product_id'].'", "'.$product_feed['SKU'].'","Entry Removal","'.$response->SubmitFeedResult->FeedSubmissionInfo->FeedSubmissionId.'",null,"0",null,"","")');
...

    {
        ...
        $mysqli->query('INSERT INTO error_reporting VALUES (null, "'.$product_feed['product_id'].'", "'.$product_feed['SKU'].'","Entry Removal",null,"503 error on product delete call","1",null,"","")');
