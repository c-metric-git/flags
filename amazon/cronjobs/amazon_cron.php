...
$sql = 'SELECT * FROM ready_for_amazon WHERE is_visible = "1" AND `isVisibleOnAmazon?` <> "1"';
...
{    
    ...
    $feed_arr[$key]['Title']            = (isset($feeds['Amazon Title']) && $feeds['Amazon Title'] != '') ? $feeds['Amazon Title'] : $feeds['title'];    
    ...
    $feed_arr[$key]['material']                      = (isset($feeds['Amazon category - search-terms5']) && $feeds['material-fabric1 entered'] != '') ? $feeds['material-fabric1 entered'] : '';    
    ...
    if($feed_arr[$key]['parentage'] == 'parent')
    {
        ...
        {            
            ...
            $feed_arr[$key]['variations'][$count]['Title']                         = (isset($var['Amazon Title']) && $var['Amazon Title'] != '') ? $var['Amazon Title'] : $var['title'];
        ...
        {            
            foreach($product_feed['variations'] as $var_key=>$var_val)
            {
                ...
                if(isset($product_feed['amzn_ship_method']) && $product_feed['amzn_ship_method'] == 'Fullfillment by Amazon')
                {
                    ...
                    $feed .= "<Quantity>".$var_val['product_quantity']."</Quantity>";
                $feed .= "</Inventory>
                    </Message>";
            }
        }
