...
define('AWS_ACCESS_KEY_ID', 'AKIAJEHUWJQXNPUZ7P3A');
define('AWS_SECRET_ACCESS_KEY', '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');
define('MERCHANT_ID', 'A6WG8LBA7FUB4'); // A1VEDA95APL570
define('MARKETPLACE_ID', 'A1F83G8C2ARO7P'); // for uk
define('APPLICATION_NAME', 'Clownantics');
define('APPLICATION_VERSION', '2.0');
define('SERVICE_URL', 'https://mws.amazonservices.co.uk');
