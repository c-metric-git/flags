 ...
 */
require_once ($_SERVER['DOCUMENT_ROOT'].preg_replace('@/+$@','','/'.FOLDER_NAME).'/API/amzn/MarketplaceWebService/Interface.php');
require_once ($_SERVER['DOCUMENT_ROOT'].preg_replace('@/+$@','','/'.FOLDER_NAME).'/API/amzn/MarketplaceWebService/RequestType.php');
...
class MarketplaceWebService_Client implements MarketplaceWebService_Interface
{
  ...
  public function getReport($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetReportRequest) {
      require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetReportRequest.php');
      $request = new MarketplaceWebService_Model_GetReportRequest($request);
    }
    require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetReportResponse.php');
  ...
  public function getReportScheduleCount($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetReportScheduleCountRequest) {
      require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetReportScheduleCountRequest.php');
      $request = new MarketplaceWebService_Model_GetReportScheduleCountRequest($request);
    }
    require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetReportScheduleCountResponse.php');
  ...
  public function getReportRequestListByNextToken($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetReportRequestListByNextTokenRequest) {
      require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetReportRequestListByNextTokenRequest.php');
      $request = new MarketplaceWebService_Model_GetReportRequestListByNextTokenRequest($request);
    }
    require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetReportRequestListByNextTokenResponse.php');
  ...
  public function updateReportAcknowledgements($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_UpdateReportAcknowledgementsRequest) {
      require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/UpdateReportAcknowledgementsRequest.php');
      $request = new MarketplaceWebService_Model_UpdateReportAcknowledgementsRequest($request);
    }
    require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/UpdateReportAcknowledgementsResponse.php');
  ...
  { 
    ...
    if (!$request instanceof MarketplaceWebService_Model_SubmitFeedRequest) {
      require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/SubmitFeedRequest.php');
      $request = new MarketplaceWebService_Model_SubmitFeedRequest($request);
    }
    require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/SubmitFeedResponse.php');
  ...
  public function getReportCount($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetReportCountRequest) {
      require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetReportCountRequest.php');
      $request = new MarketplaceWebService_Model_GetReportCountRequest($request);
    }
    require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetReportCountResponse.php');
  ...
  public function getFeedSubmissionListByNextToken($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetFeedSubmissionListByNextTokenRequest) {
      require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetFeedSubmissionListByNextTokenRequest.php');
      $request = new MarketplaceWebService_Model_GetFeedSubmissionListByNextTokenRequest($request);
    }
    require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetFeedSubmissionListByNextTokenResponse.php');
  ...
  public function cancelFeedSubmissions($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_CancelFeedSubmissionsRequest) {
      require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/CancelFeedSubmissionsRequest.php');
      $request = new MarketplaceWebService_Model_CancelFeedSubmissionsRequest($request);
    }
    require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/CancelFeedSubmissionsResponse.php');
  ...
  public function requestReport($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_RequestReportRequest) {
      require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/RequestReportRequest.php');
      $request = new MarketplaceWebService_Model_RequestReportRequest($request);
    }
    require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/RequestReportResponse.php');
  ...
  public function getFeedSubmissionCount($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetFeedSubmissionCountRequest) {
      require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetFeedSubmissionCountRequest.php');
      $request = new MarketplaceWebService_Model_GetFeedSubmissionCountRequest($request);
    }
    require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetFeedSubmissionCountResponse.php');
  ...
  public function cancelReportRequests($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_CancelReportRequestsRequest) {
      require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/CancelReportRequestsRequest.php');
      $request = new MarketplaceWebService_Model_CancelReportRequestsRequest($request);
    }
    require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/CancelReportRequestsResponse.php');
  ...
  public function getReportList($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetReportListRequest) {
      require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetReportListRequest.php');
      $request = new MarketplaceWebService_Model_GetReportListRequest($request);
    }
    require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetReportListResponse.php');
  ...
  public function getFeedSubmissionResult($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetFeedSubmissionResultRequest) {
      require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetFeedSubmissionResultRequest.php');
      $request = new MarketplaceWebService_Model_GetFeedSubmissionResultRequest($request);
    }
    require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetFeedSubmissionResultResponse.php');
  ...
  public function getFeedSubmissionList($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetFeedSubmissionListRequest) {
      require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetFeedSubmissionListRequest.php');
      $request = new MarketplaceWebService_Model_GetFeedSubmissionListRequest($request);
    }
    require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetFeedSubmissionListResponse.php');
  ...
  public function getReportRequestList($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetReportRequestListRequest) {
      require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetReportRequestListRequest.php');
      $request = new MarketplaceWebService_Model_GetReportRequestListRequest($request);
    }
    require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetReportRequestListResponse.php');
  ...
  public function getReportScheduleListByNextToken($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetReportScheduleListByNextTokenRequest) {
      require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetReportScheduleListByNextTokenRequest.php');
      $request = new MarketplaceWebService_Model_GetReportScheduleListByNextTokenRequest($request);
    }
    require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetReportScheduleListByNextTokenResponse.php');
  ...
  public function getReportListByNextToken($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetReportListByNextTokenRequest) {
      require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetReportListByNextTokenRequest.php');
      $request = new MarketplaceWebService_Model_GetReportListByNextTokenRequest($request);
    }
    require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetReportListByNextTokenResponse.php');
  ...
  public function manageReportSchedule($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_ManageReportScheduleRequest) {
      require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/ManageReportScheduleRequest.php');
      $request = new MarketplaceWebService_Model_ManageReportScheduleRequest($request);
    }
    require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/ManageReportScheduleResponse.php');
  ...
  public function getReportRequestCount($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetReportRequestCountRequest) {
      require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetReportRequestCountRequest.php');
      $request = new MarketplaceWebService_Model_GetReportRequestCountRequest($request);
    }
    require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetReportRequestCountResponse.php');
  ...
  public function getReportScheduleList($request)
  {
    if (!$request instanceof MarketplaceWebService_Model_GetReportScheduleListRequest) {
      require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetReportScheduleListRequest.php');
      $request = new MarketplaceWebService_Model_GetReportScheduleListRequest($request);
    }
    require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/GetReportScheduleListResponse.php');
      ...
      do {
        try {
          ...
          switch ($httpStatus) {
          	...
          	case 500:
          	case 503:
          		require_once($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/API/amzn/MarketplaceWebService/Model/ErrorResponse.php');
  ...
  private function performRequest($action, array $converted, $dataHandle = null, $contentMd5 = null) {
	...
	//print_r($this->errorResponseBody);
