 ...
 */
 require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/amazon.mws/MarketplaceWebService/Model.php');  
require_once ($_SERVER['DOCUMENT_ROOT'].'/'.FOLDER_NAME.'/amazon.mws/MarketplaceWebService/Model/ContentType.php');
