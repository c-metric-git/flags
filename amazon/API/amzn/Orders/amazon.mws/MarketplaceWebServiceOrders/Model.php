 ...
 *  Generated: Tue Sep 13 01:44:08 GMT 2011
 * 
 */
            ...
            if (is_array($fieldType)) {
                if ($this->_isComplexType($fieldType[0])) {
                    ...
                    if ($elements->length >= 1) {
                        $main_folders = explode('MarketplaceWebServiceOrders',dirname(__FILE__)); 
                        require_once ($main_folders[0].str_replace('_', DIRECTORY_SEPARATOR, $fieldType[0]) . ".php");
                ...
                if ($this->_isComplexType($fieldType)) {
                    ...
                    if ($elements->length == 1) {
						$main_folders = explode('MarketplaceWebServiceOrders',dirname(__FILE__)); 
                        require_once ($main_folders[0].str_replace('_', DIRECTORY_SEPARATOR, $fieldType) . ".php");
