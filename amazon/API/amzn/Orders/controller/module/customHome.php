<?php
class ControllerModuleCustomHome extends Controller
{
    private $error = array();
    ...
    public function index()
    {
     ...
     $this->load->language('module/customHome');


        //Set the title from the language file $_['heading_title'] string

              $this->document->setTitle('Custom Home content module');
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validate())) {
            ...
            $this->model_setting_setting->editSetting('customHome', $this->request->post);
        ...
        $this->document->breadcrumbs[] = array('href' => HTTPS_SERVER .
            'index.php?route=module/customHome&token=' . $this->session->data['token'],
            'text' => $this->language->get('heading_title'), 'separator' => ' :: ');

        $this->data['action'] = HTTPS_SERVER . 'index.php?route=module/customHome&token=' .
     ...
     /*   $this->data['positions'] = array();
        ...
        $this->data['positions'][] = array('position' => 'left', 'title' => $this->
            language->get('text_left'), );
        //REMOVE THIS IF YOUR MODULE CAN'T GO IN THE RIGHT COLUMN
        $this->data['positions'][] = array('position' => 'right', 'title' => $this->
            language->get('text_right'), );
        //REMOVE THIS IF YOUR MODULE CAN'T GO ON THE HOME PAGE CENTER COLUMN
        $this->data['positions'][] = array('position' => 'home', 'title' => $this->
            language->get('text_home'), );
...
*/
        ...
        //
        $config_data = array('customHome_status',
             'custom_html');
        ...
        $this->template = 'module/customHome.tpl';
    ...
    */
    ...
    {
        if (!$this->user->hasPermission('modify', 'module/customHome')) {
