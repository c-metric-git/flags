<?php
class ControllerModuleCustomFooterGentle extends Controller
{
    private $error = array();
    ...
    public function index()
    {
        ...
        $this->load->language('module/customFooterGentle');
	...
	if (isset($this->request->post['about_us_image'])) {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && ($this->validate())) {
            ...
            $this->model_setting_setting->editSetting('customFooterGentle', $this->request->post);
        ...
        $this->document->breadcrumbs[] = array('href' => HTTPS_SERVER .
            'index.php?route=module/customFooterGentle&token=' . $this->session->data['token'],
            'text' => $this->language->get('heading_title'), 'separator' => ' :: ');

        $this->data['action'] = HTTPS_SERVER . 'index.php?route=module/customFooterGentle&token=' .
        ...
        'facebook_status',
        'facebook_id',
        'custom_footer_gentle_column_status',
        'custom_footer_gentle_column_header',
        'custom_footer_gentle_column_content',
        ...
        $this->template = 'module/customFooterGentle.tpl';
    ...
    */
    ...
    {
        if (!$this->user->hasPermission('modify', 'module/customFooterGentle')) {
