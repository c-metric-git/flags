...
class Evince_Ajaxaddtocart_Model_Response extends Mage_Catalog_Block_Product_Abstract {
    ...
    public function addUpdatedBlocks(&$_response) {
        $updated_blocks = unserialize(Mage::getStoreConfig('ajaxaddtocart/general/update_blocks'));
    ...
    public function addConfigurableOptionsBlock(&$_response) {
        ...
        $layout->getUpdate()->addHandle('ajaxaddtocart_configurable_options');
        
        if ($_product->getTypeId() == 'bundle')
        $layout->getUpdate()->addHandle('ajaxaddtocart_bundle_options');        
        ...
        $value = $layout->getBlock('ajaxaddtocart.configurable.options');        
    ...
    public function addGroupProductItemsBlock(&$_response) {
        ...
        $layout->getUpdate()->addHandle('ajaxaddtocart_grouped_options');
        ...
        $value = $layout->getBlock('ajaxaddtocart.grouped.options');
