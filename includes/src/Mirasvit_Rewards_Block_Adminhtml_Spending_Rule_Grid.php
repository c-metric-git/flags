...
class Mirasvit_Rewards_Block_Adminhtml_Spending_Rule_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        $collection = Mage::getModel('rewards/spending_rule')
            ->getCollection();
    ...
    {
        $this->addColumn('spending_rule_id', array(
