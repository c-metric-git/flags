 ...
 */
class Teamdesk_Importmodule_Model_Adapter
{
    /**
    ...
    public static function factory($type, $options = null)
    {
        ...
        if (! $adapter instanceof Teamdesk_Importmodule_Model_Adapter_Abstract) {
            Mage::throwException(
                Mage::helper('importexport')->__('Adapter must be an instance of Teamdesk_Importmodule_Model_Abstract')
            );
        }
        return $adapter;
    }
