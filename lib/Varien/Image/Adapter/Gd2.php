...
class Varien_Image_Adapter_Gd2 extends Varien_Image_Adapter_Abstract
{
    ...
    public function __construct()
    {
        ...
        //register_shutdown_function(array($this, 'destruct'));     //commented by dinesh
    }

    /**
     * Destroy object image on shutdown
     */
    public function __destruct()      // done by dinesh: change function name destruct to __destruct
    {
