...
$myFile = "csv/tblteamdesk_filter_size.csv"; // File in which attribute option values are there.
$f = fopen($myFile, "r");
...
for($i=0;$i<count($myValue);$i++)
 ...
 $attribute_code  = $attribute_model->getIdByCode('catalog_product', 'fl_filter_size');
 $attribute       = $attribute_model->load($attribute_code);
 
if(!attributeValueExists('fl_filter_size', $myValue[$i]))
 {
