...
$myFile = "csv/seasonal_sub_themes.csv"; // File in which attribute option values are there.
 $f = fopen($myFile, "r");
...
for($i=0;$i<count($myValue);$i++)
 ...
 $attribute_code  = $attribute_model->getIdByCode('catalog_product', 'season_subtheme');
 $attribute       = $attribute_model->load($attribute_code);
 
if(!attributeValueExists('season_subtheme', $myValue[$i]))
 {
