...
class Mirasvit_Rewards_Model_Notification_Rule_Condition_Custom extends Mage_Rule_Model_Condition_Abstract
{
    public function loadAttributeOptions()
    {
        $attributes = array(
            'clicks_7' => Mage::helper('rewards')->__('Last 7-days Clicks'),
            'orders_7' => Mage::helper('rewards')->__('Last 7-days Orders'),
            'revenue_7' => Mage::helper('rewards')->__('Last 7-days Revenue'),
            'cr_7' => Mage::helper('rewards')->__('Last 7-days Conversation Rate (%)'),
        );
    ...
    public function collectValidatedAttributes($productCollection)
    {
        ...
        $select->from(array('ta' => $resource->getTableName('rewards/performance_aggregated')), array($expr))
