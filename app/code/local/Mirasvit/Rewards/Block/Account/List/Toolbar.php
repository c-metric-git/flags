...
class Mirasvit_Rewards_Block_Account_List_Toolbar extends Mage_Core_Block_Template
{
    ...
    {
        $pagerBlock = $this->getLayout()->createBlock('rewards/account_list_pager', 'rewards.account.pager');
...
class Mirasvit_Rewards_Block_Account_List_Pager extends Mage_Page_Block_Html_Pager
{
    public function getPagerUrl($params = array())
    {
        $url = parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH);
