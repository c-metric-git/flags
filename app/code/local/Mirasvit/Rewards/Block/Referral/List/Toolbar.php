...
class Mirasvit_Rewards_Block_Referral_List_Toolbar extends Mage_Core_Block_Template
{
    ...
    {
        $pagerBlock = $this->getLayout()->createBlock('rewards/referral_list_pager', 'rewards.referral.pager');
...
class Mirasvit_Rewards_Block_Referral_List_Pager extends Mage_Page_Block_Html_Pager
{
    public function getPagerUrl($params = array())
    {
        $url = parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH);
