...
class Amasty_Shiprestriction_Block_Adminhtml_Rule_Edit_Tab_General extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fldInfo->addField('coupon', 'text', array(
            ...
            'name'      => 'coupon',
            'note'      => $hlp->__('Apply this shipping restriction when specified coupon is provided. You can configure coupon in promotions / shopping cart rules. Useful when you have ONE coupon only.'),
        ));
