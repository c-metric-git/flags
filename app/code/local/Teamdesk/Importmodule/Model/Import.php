 ...
 */
class Teamdesk_Importmodule_Model_Import extends Mage_ImportExport_Model_Abstract
{
    /**
        ...
        if (!$this->_entityAdapter) {      
            ...
            if (isset($validTypes[$this->getEntity()])) {
                try {                   
                    ...
                    //$this->_entityAdapter = new Teamdesk_Importmodule_Model_Entity_Product();//Mage::getModel("importmodule/entity_product");     
                } catch (Exception $e) {
                    Mage::logException($e);
                    Mage::throwException(
    ...
    {                          
        return Teamdesk_Importmodule_Model_Adapter::findAdapterFor($sourceFile);
    }
