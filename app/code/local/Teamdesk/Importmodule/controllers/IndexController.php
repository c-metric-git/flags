            ...
            switch($import_type) {
                ...
                case 'FL_products' :
                    ...
                    for($i=0;$i<=$product_csv_counter;$i++) {                   
                        ...
                        echo $succ_message['success'] .= "<br /><br />Processing File => FL_Products$i.csv<br />";    
                    ...
                    for($i=0;$i<=$bundle_product_csv_counter;$i++) {                   
                        ...
                        $succ_message['success'] .= "<br /><br />Processing File => FL_BundleProducts$i.csv<br />";    
                        $tmp_succ_message = $this->AddProduct("var/import/products/FL_BundleProducts$i.csv");
                        echo '<pre>';
                        print_R($tmp_succ_message);
                        if($tmp_succ_message['success']!='') {
                             $succ_message['success'] .= $tmp_succ_message['success'];
                   ...
                   // foreach ($indexCollection as $index) { 
                    ...
                    $bundle_product_csv_counter = $_SESSION['bundle_product_csv_counter']!=''?$_SESSION['bundle_product_csv_counter']:0;   
                    for($i=0;$i<=$bundle_product_csv_counter;$i++) {                   
                        $succ_message['error'] .= "<br /><br />Processing File => FP_BundleProducts$i.csv<br />";   
                        $succ_message['success'] .= "<br /><br />Processing File => FP_BundleProducts$i.csv<br />";    
                        $tmp_succ_message = $this->AddProduct("var/import/products/FP_BundleProducts$i.csv");
                        echo '<pre>';
                        print_R($tmp_succ_message);
                        if($tmp_succ_message['success']!='') {
                             $succ_message['success'] .= $tmp_succ_message['success'];
                                              ...
                                              foreach($bundle_pr_selection as $pr_id =>$bundle_selection) {
                                                  if($bundle_selection == $bundle_product_id && $option_array[$opt_id]->getData('default_title') !='Palettes') {
                                                      $product_already_there = "yes";
                                                       ...
                                                       $bundleSelections[$opt_id][$s]['selection_price_type'] = '0'; //  fixed : 0 and percent 1
                                        ...
                                        */
                                        ...
                                        for($i=0;$i<$num_of_options;$i++) {    
                                            ...
                                            if($bundle_product_id!= '') {
                                                ...
                                                $bundleSelections[0][$k]['selection_price_type'] = '0'; //  fixed : 0 and percent 1   
                            ...
                            if(count($children)==0) {    
                                ...
                                if(count($bundleUpdatedSelections)>0) {
                                    if($required_sku_for_kit !='') {
                                        ...
                                        $bundleUpdatedSelections[$num_of_options][0]['selection_price_type'] = '0'; //  fixed : 0 and percent 1  
                                ...
                                $bundleSelections[$bundle_option_id][0]['selection_price_type'] = '0'; //  fixed : 0 and percent 1   
